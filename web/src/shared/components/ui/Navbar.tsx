    ...
    <header className="flex h-16 items-center justify-between border-b border-border-custom bg-card px-4 md:px-6 shadow-custom-sm sticky top-0 z-30 select-none">
      ...
      <div className="flex items-center gap-3">
        <button
          ...
          className="flex h-9 w-9 items-center justify-center rounded-lg border border-border-custom text-text-muted hover:bg-app-bg hover:text-primary focus:outline-none lg:hidden"
      ...
      <div className="flex items-center gap-4 flex-1 justify-end max-w-xl">
        ...
        <button
          className="relative flex h-9 w-9 items-center justify-center rounded-lg border border-border-custom bg-card text-text-muted shadow-custom-sm transition-all duration-200 hover:bg-app-bg hover:text-primary focus:outline-none"
